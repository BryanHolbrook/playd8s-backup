  ...
  return(
    <div>
      ...
      <div className="container">
        <br></br>
        <h2 className="header center-align">Dashboard Newsfeed</h2>
        <div className="row center">
          <h5 className="header col s12 light">Check out the top game articles of the last week!</h5>
      ...
      <div className="row l8 m10">
        {this.state.pulses.slice(0,50).map((pulse, index) => {
          return (
            <div key={index} className="col m4">
              <div className="card">
                <div className="card-image">
                  <img src={pulse.image ? pulse.image : '/images/img01.png'} />
                </div>
